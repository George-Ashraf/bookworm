    ...
    <div class="buy">
        <div class="container px-4 py-5 mx-auto">
            <div class="row d-flex justify-content-center">
                <div class="col-5">
                    <h4 class="heading">book ticket for offline seminar</h4>
                </div>
                <div class="col-7">
            ...
            <div class="row d-flex justify-content-center border-top">
                <div class="col-5">
                    <div class="row d-flex">
                        <div class="book">
                            <img src="{{ asset('assets/img/payment/ticket.jpg') }}"
                                class="book-img">
                        </div>
            ...
            <div class="row justify-content-center">
                <form action="{{ route('seminar.storepayment') }}" method="POST">
            ...
            <form action="{{ route('seminar.storepaymentcash') }}" method="POST" class="d-flex justify-content-center">
            @csrf
            <input type="hidden" value="{{$seminar->id}}" name="seminar_id">



            <button class="btn-block btn-blue col-lg-12">
                <span>
                    <span id="checkout"><i class="fa-solid fa-money-bills mr-1"></i>Cash</span>
                    <span id="check-amt">100 LE</span>
