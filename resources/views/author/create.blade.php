            ...
            <div class="register-container" id="Register">
                <form method="POST" action="{{ route('author.store') }}">
                    ...
                    <div class="top">
                        ...
                        <div class="head">Sign Up as author</div>
                    </div>
                    ...
                    <div class="input-box">
                        <input id="name" type="text" class=" @error('experience') is-invalid @enderror input-field"
                            name="experience" value="{{ old('experience') }}" autofocus placeholder="experience">
                    ...
                    <div class="input-box">
                        <input id="name" type="text"
                            class="input-field @error('type_of_write') is-invalid @enderror" name="type_of_write"
                            value="{{ old('type_of_write') }}" autofocus placeholder="type of write">
