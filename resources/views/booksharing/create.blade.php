...
@section('content')
    <div class="allforms">
        ...
        <form class="container-fluid col-lg-7" method="POST" action="{{ route('book.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="name" value="{{Auth()->user()->name}}" class="@error('name') is-invalid @enderror form-control" value="{{ old('name') }}">
            ...
            <div class="form-group">
                ...
                <textarea name="book_you_want_description" class="@error('book_you_want_description') is-invalid @enderror form-control" rows="3">
                    {{ old('book_you_want_description') }}
                </textarea>
