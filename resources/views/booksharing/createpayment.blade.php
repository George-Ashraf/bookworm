    ...
    <div class="buy">
        <div class="container px-4 py-5 mx-auto">
            ...
            <div class="row d-flex justify-content-center border-top">
                <div class="col-5">
                    <div class="row d-flex">
                        <div class="book">
                            <img src="{{ asset('attachments') . '/' . 'booksharing_one' . $booksharing_one->id . '/' . $booksharing_one->book_cover }}"
                                class="book-img">
                        </div>
                        <div class="my-auto flex-column d-flex pad-left">
                            <h6 class="mob-text">{{ $booksharing_one->book_name }}</h6>
                            <p class="mob-text">{{ $booksharing_one->author }}</p>
                        </div>
                    </div>
                </div>
                <div class="my-auto col-7">
                    <div class="row text-right">
                        <div class="col-4">
                            <p class="mob-text">{{ $booksharing_one->format }}</p>
                        </div>
                        <div class="col-4">
            ...
            <div class="row justify-content-center">
                <form action="{{ route('sharepaymentone.store') }}" method="POST">
                    @csrf
                    <input type="hidden" value="{{ $booksharing_one->id }}" name="booksharing_one_id">
                    <input type="hidden" value="{{ $booksharing_one->BS_section_id }}" name="BS_section_id">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="row">
            ...
            @if ($booksharing_one->format == 'hard copy')
                <form action="{{ route('sharepaymentonecash.store') }}" method="POST"
